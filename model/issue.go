...
type Issue struct {
	...
	ParentIssueID   *uint64        `json:"-"`
	Status          uint8          `json:"status"`
	ChildIssues     []Issue        `gorm:"foreignkey:ParentIssueID;" json:"issue"`
	DependentIssues []Issue        `gorm:"many2many:DependentIssues;" json:"dependentIssues"`
	Comments        []IssueComment `gorm:"foreignkey:ID;constraint:onUpdate:CASCADE,onDelete:CASCADE" json:"comments"`
